...
Answer: We could use catchError to deal with any error that occurs in the observable stream. This could deal with 400s, 500s, timeouts ect. We'd then return a new observable with an error action.
